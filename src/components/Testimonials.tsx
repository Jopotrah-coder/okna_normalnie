...
const Testimonials: React.FC = () => {
  ...
  const testimonials = [
    ...
    {
      text: "Компания Окна-НН делала мне панорамное остекление в загородном доме. Получилось шикарно! Качество на высоте, энергосбережение работает как надо, зимой тепло не уходит.",
      author: "Дмитрий Иванов",
      role: "Владелец коттеджа",
      image: "https://randomuser.me/api/portraits/men/55.jpg"
    },
    {
      text: "Спасибо команде Окна-НН за профессионализм! Выбрали стильные входные группы для нашего офиса, все смонтировали в выходные, чтобы не мешать рабочему процессу. Большое спасибо!",
